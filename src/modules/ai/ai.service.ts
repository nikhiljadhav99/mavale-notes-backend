...
export const createVoiceChatResponse = async (input: VoiceChatInput) => {
  ...
  const response = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      instructions:
        "You are the Smart Notes voice assistant. Be concise, practical, and friendly. Help with notes, reminders, summaries, and productivity. Keep spoken answers short unless the user asks for detail.",
